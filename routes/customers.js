...
exports.save = function (req, res) {
    ...
    var cols = [encrypt(req.body.name), encrypt(req.body.address), encrypt(req.body.email), encrypt(req.body.phone)];
...
exports.update = function (req, res) {
    ...
    var cols = [encrypt(req.body.name), encrypt(req.body.address), encrypt(req.body.email), encrypt(req.body.phone), req.params.id];
